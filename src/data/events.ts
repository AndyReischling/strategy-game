...
export const WORLD_EVENTS: WorldEvent[] = [
  {
    ...
    effectText: "All Nvidia-based options cost +§1. The ASML token holder collects +§1.",
    effects: [
      { kind: "surcharge-tag", tags: ["nvidia"], amount: 1 },
    ],
    terms: ["nvidia", "asml"],
  },
  {
    ...
    effectText: "All build-your-own compute options cost +§1. Renting suddenly looks tempting — the trap.",
    effects: [
      { kind: "surcharge-tag", tags: ["domestic-build"], amount: 1 },
    ],
  },
  {
    id: "ev-energy-crunch",
    ...
    effectText: "Non-renewable compute builds cost +§2. Nordics and renewable power are immune.",
    effects: [
      { kind: "surcharge-tag", tags: ["nuclear"], amount: 1, exemptRegionIds: ["france"] },
      { kind: "surcharge-tag", tags: ["domestic-build"], amount: 2, exemptTags: ["renewable"], exemptRegionIds: ["nordics"] },
    ],
    terms: ["compute"],
  },
  {
    ...
    effectText: "Fine-tune & continued pre-training cost −§1. A good round to own, not rent.",
    effects: [
      { kind: "discount-tag", tags: ["finetune", "continued"], amount: 1 },
    ],
  ...
  },
  {
    ...
    effectText: "Rented / foreign options cost −§1 now — but each one adds +1 exposure to this round's off-switch die.",
    effects: [
      { kind: "discount-tag", tags: ["rented", "foreign"], amount: 1 },
  ...
  },
  {
    ...
    effectText: "All model-building costs +§1 — except Canada and India.",
    effects: [
      { kind: "surcharge-tag", tags: ["model-build"], amount: 1, exemptRegionIds: ["canada", "india"] },
    ],
  },
  {
    id: "ev-swf-floods",
    ...
    effectText: "Take +§3 this round if you accept a standing investment (the backer gets 15% of your final score).",
    effects: [
      { kind: "swf-stipend", amount: 3 },
    ],
  ...
  },
  {
    ...
    effectText: "Every deal grants +1 bonus Deal-score; shared-cluster / coalition-weights cost −§1.",
    effects: [
      { kind: "deal-bonus", amount: 1 },
      { kind: "discount-tag", tags: [], optionIds: ["co-coalition", "w-coalition"], amount: 1 },
    ],
    terms: ["standing-deal"],
  },
  {
